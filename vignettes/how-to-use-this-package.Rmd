...
## Initialization of entropy outputs csv
```{py}
import sys
import codecs
import os
...
```{py}
#Define initial parameters
file_name = str(input("What is the path of the file ? "))#Inputs data csv file (and its path)
Z =  str(input("What is the first studied variable column number ? ")) #First studied variable column number
W = Z #Second studied variable column number
A = str(input("How many variables do you want to study the association ? ")) #Number of studied variables
B = 0 
C = 0
D = 0
...
def parse_command_line1():
    ...
    file_name = '/disks/PROJECT/RNAseq_MickaelCanouil/outputs/test_python/entropy_phenotype_data.csv'
    col_X = Z
    col_Y = W
    lag_Y_on_X = 0
    n_X = 0
...
def main():
    ...
    f = open('/disks/PROJECT/RNAseq_MickaelCanouil/outputs/test_python/output.csv'.format(name_X, name_Y), "w+")
...
while C <=  A:
    while D <  A :
        ...
        if __name__ == '__main__':
            ...
            # Default parameter values
            file2_name = '/disks/PROJECT/RNAseq_MickaelCanouil/outputs/test_python/output.csv'
        ...
        z = open('/disks/PROJECT/RNAseq_MickaelCanouil/outputs/test_python/entropy_outputs.csv', 'a+', newline = '')
        with z:
            writer = csv.writer(z)
